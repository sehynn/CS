...
6. Virtual DOM
7. 리액트의 스케줄링
   - 브라우저 렌더링 시 작업의 우선순위를 정하고 분배하여 처리하는 핵심 메커니즘. 우선순위 큐를 사용한다. 
...
- 이럴 땐 리액트 -> 대규모 프로젝트/확장성이 중요/모바일 앱까지 고려
- 이럴 땐 뷰 -> 개발 인원이 적고 빠른 MVP/HTML,CSS 기반의 직관적인 코드 구조/빠르게 기술 습득하고 싶을 때 
